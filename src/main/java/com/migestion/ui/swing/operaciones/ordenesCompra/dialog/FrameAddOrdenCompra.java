...
/**
 * OrdenComprana para agregar una orden de compra.
 * 
 * @author Bernardo Iribarne (ber.iribarne@gmail.com)
 * @since 22/11/2013
 * 
 */
public class FrameAddOrdenCompra extends javax.swing.JInternalFrame implements  TableModelListener, ILinkWindowOpen, ListSelectionListener{
    ...
    private DetalleOrdenCompraTableController detallesController;
    private UIDetalleOrdenCompraCollection detallesModel;	

    private DetalleOrdenCompra detalleSeleccionado;
    ...
    /**
     * Creates new form FrameAddOrdenCompra
     */
    public FrameAddOrdenCompra() {
        
    	super(I18nMessages.ORDEN_COMPRA_DIALOG_AGREGAR_TITULO, true, false, true, true);
    ...
    private void initComponents() {
        ...
        findProveedor = FinderFactory.getFindProveedor(new LinkFindObjectListener() {
            ...
            public void objectFound(Object objectFinded) {
                ...
                ordenCompra.setProveedor( (Proveedor) objectFinded);
            }
        });
        findVendedor = FinderFactory.getFindVendedor(new LinkFindObjectListener() {
            ...
            public void objectFound(Object objectFinded) {
                ...
                ordenCompra.setVendedor( (Vendedor) objectFinded);
            }
        });
        ...
        panelDatosVentaLayout.setHorizontalGroup(
            ...
            .addGroup(panelDatosVentaLayout.createSequentialGroup()
                ...
                .addGroup(panelDatosVentaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(panelDatosVentaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelDatosVentaLayout.createSequentialGroup()
                        .addGroup(panelDatosVentaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(findProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 494, Short.MAX_VALUE)
                    ...
                    .addGroup(panelDatosVentaLayout.createSequentialGroup()
                        .addComponent(pickerFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnAgregar.setText("Agregarlo a la  orden");
        btnAgregar.setMinimumSize(new Dimension(110, 23));
        //btnAgregar.setToolTipText(ButtonLabelsBundle.btn_Add_ToolTipText);
        //btnAgregar.setIcon(new ImageIcon(ButtonImagesBundle.btn_Add));
            ...
            .addGroup(panelAddProductoLayout.createSequentialGroup()
                ...
                .addGroup(panelAddProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelAddProductoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(findProducto, javax.swing.GroupLayout.DEFAULT_SIZE, 466, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameAddOrdenCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameAddOrdenCompra().setVisible(true);
            }
        });
    }
	...
	protected void doOk(){		
		try {			
			...
			OrdenCompra ordenCompra = getObjectFromUI();
			
			UIServiceFactory.getUIOrdenCompraService().addObject(ordenCompra);
			...
			DialogAddOrdenCompraRegistrarPago dialogRegistrarPago = new DialogAddOrdenCompraRegistrarPago(new Frame(), true);
		    ...
		    if( dialogRegistrarPago.getReturnStatus() == DialogSeleccionarFormaPago.RET_OK ){
		    	...
		    	LinkPagarOrdenCompra link = LinkPagoFactory.getLinkPagarOrdenCompra();
		    	link.setObject( ordenCompra );
		    	link.doExecute();
	...
	private OrdenCompra getObjectFromUI() {
		
		ordenCompra.setFecha( pickerFecha.getDate() );
		ordenCompra.setObservaciones( txtObservaciones.getText() );
		
		ordenCompra.setDetalles( new ArrayList<DetalleOperacion>() );
		
		for (DetalleOrdenCompra detalle: detallesController.getDetalles()) {
			
			ordenCompra.addDetalle(detalle);
		}
		
		ordenCompra.setSucursal( (Sucursal)cmbSucursal.getSelectedItem() );
		return ordenCompra;
	}
	...
	public void clearInputs() {
		findProveedor.objectFound(null);
...
//    	ordenCompra.setCliente(AppContext.getInstance().getClienteDefault() );
//    	findCliente.objectFound( ordenCompra.getCliente() );
//    	
    	ordenCompra.setVendedor( AppContext.getInstance().getVendedorDefault() );
    	findVendedor.objectFound( ordenCompra.getVendedor() );
	...
	private void initValidators() {
		...
		required.put(lblProveedor, findProveedor, new JFindObjectInspector());
    ...
    private void initTableDetalles(){
    	...
    	detallesModel = new UIDetalleOrdenCompraCollection("Detalles", true);
		detallesModel.addTableModelListener(this);

		detallesController = new DetalleOrdenCompraTableController(detallesModel);
	...
	public void tableChanged(TableModelEvent arg0) {
		...
		ordenCompra.setMonto(montoTotal);
...
//        cmbTipoDoc.setSelectedIndex(0);
	...
	private void alertListeners(){
		...
		while (iter.hasNext()) {
			...
			element.objectCreated( getOrdenCompra() );			
		}
	}
