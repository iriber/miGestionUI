...
/**
 * UICollection para detalles de órden de compra. 
 * 
 * @author Bernardo Iribarne (ber.iribarne@gmail.com)
 * @since 22/11/2013
 *
 */
public class UIDetalleOrdenCompraCollection extends UIFooterCollection{

	private Boolean editable;

	private HashMap<Integer, Object> footer;
	
	public UIDetalleOrdenCompraCollection(String description, Boolean editable) {
		super(description);
	...
	public Object getEntityValueAt(int rowIndex, int columnIndex) {
		...
		DetalleOrdenCompra detalle = (DetalleOrdenCompra)(getElements().get(rowIndex));
...
//	}
	...
	protected void setFooter(List items) {
		...
		for (Object item : items) {
			...
			DetalleOrdenCompra detalle = (DetalleOrdenCompra)item;
