 ...
 *
 */
public class LinkMovimientoNotaCreditoFactory {



	/**
	 * link para listar movimientos de notas de crédito.
	 * @return
	 */
	public static LinkListCollection getLinkList(){
		LinkListCollection link = new LinkListCollection(WindowMovimientoNotaCreditoFactory.getWindowList(), I18nMessages.MOVIMIENTO_NOTA_CREDITO_FRAME_TITULO, I18nImages.MOVIMIENTOS_CUENTA_ICON);
