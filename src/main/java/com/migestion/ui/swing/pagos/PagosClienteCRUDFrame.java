 ...
 *
 */
public class PagosClienteCRUDFrame extends CRUDFrame<PagoCliente> implements IPagoClienteListener{

	public PagosClienteCRUDFrame(String title, IControllerList controller){
	...
	public void initLinks() {
		...
		LinkOpenDialogWithSelected linkView = LinkPagoFactory.getLinkViewPagoCliente();
		this.addElementsListener(linkView);

		LinkOpenDialogWithSelected linkAnular = LinkPagoFactory.getLinkAnularPagoCliente();
		this.addElementsListener(linkAnular);

		LinkOpenDialogWithSelected linkDelete  = LinkPagoFactory.getLinkDeletePagoCliente();
