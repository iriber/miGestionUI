 ...
 *
 */
public class LinkAddPago extends Link implements LinkAddListener{
	...
	public LinkAddPago(FrameAddVenta dialog, String title, URL pathSmallIcon){
	 ...
	 */
	public LinkAddPago(FrameAddVenta dialog){
		this(dialog, I18nMessages.PAGO_ACCION_AGREGAR, LinkImagesBundle.link_Add);
