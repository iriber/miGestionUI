 ...
 * @author bernardo
 */
public class UIGastoCriteriaPanel extends javax.swing.JPanel  implements ICriteriaPanel{

	
    /**
     * Creates new form UIGastoCriteriaPanel
     */
    public UIGastoCriteriaPanel() {
	...
	public UICriteria getCriteria() throws ViewException{
		...
		UIGastoCriteria criteria = new UIGastoCriteria();
	...
	public void setCriteria(UICriteria criteria) {
		...
		criteriaFechaRangoPanel.setFechaDesde(((UIGastoCriteria)criteria).getFechaDesde());
		criteriaFechaRangoPanel.setFechaHasta(((UIGastoCriteria)criteria).getFechaHasta());
